# source-code-retriever-tool

Migrated from Hugging Face Spaces.

## Original Space

- URL: https://huggingface.co/spaces/Chris4K/source-code-retriever-tool
- SDK: gradio
...
1. **Private Monorepo** (development)
   - Location: `apps/huggingface/source-code-retriever-tool/`
   - All development happens here
   - Contains secrets and private configuration

2. **Public GitHub Repository**
   - URL: https://github.com/Ckal/source-code-retriever-tool
